...
public class PostApplicationAsyncRetriever extends AsyncTask<ApplicationToAdd, Void, String> {

    @Override
    protected String doInBackground(ApplicationToAdd... params) {
        String url = ApiConstants.baseApi + "/api/Application";
        String result = "";

        ApplicationToAdd request = params[0];
        ...
        try {
            jsonObj.put("userId", request.userId);
            jsonObj.put("patternId", request.patternId);
