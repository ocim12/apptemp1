...
public class PostPatternAsyncRetriever  extends AsyncTask<PatternToAdd, Void, String> {


    @Override
    protected String doInBackground(PatternToAdd... params) {
        String url = ApiConstants.baseApi + "/api/AccreditationPattern";
        String result = "";

        PatternToAdd request = params[0];
        ...
        try {
            jsonObj.put("name", request.name);
            jsonObj.put("description", request.description);
